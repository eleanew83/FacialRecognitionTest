#!/usr/bin/env python3
"""Gradio MVP for macaque face identification and enrollment."""
...
def build_interface():
    with gr.Blocks(title="Macaque Face ID") as demo:
        status = gr.State("")

        gr.Markdown("# Macaque Face Identification (MVP)\nUpload cropped face images to identify or enroll.")
        with gr.Row():
        ...
        with gr.Tab("Identify"):
            img = gr.Image(type="pil", label="Cropped macaque face")
